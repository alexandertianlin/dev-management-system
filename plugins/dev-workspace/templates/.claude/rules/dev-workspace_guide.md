...
dev-workspace creates isolated workspaces to keep work and context (plans, docs, etc) scoped to the task at hand.
...
### Workspace Commands
- init, new, push, sync, merge, commit, archive
- plan, review (available via /plugin commands)

### Skills
- **dev-workspace** — CLI for workspace management
- **quality-gates** — Code quality enforcement
- **prd-planner** — PRD-driven planning
- **conversation-capture** — Session history
...
Archived workspaces live in `dev/branches/`.

### Chat Histories

Each workspace has conversations recorded in `/history`. Each history file has a max 5-line summary:
